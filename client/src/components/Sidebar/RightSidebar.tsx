...
import { IUser } from "types/UserInterfaces";
 interface RightSidebarProps {
  ...
  return (
    <aside className="w-[280px] md:sticky md:top-0  flex-1 lg:flex-none   flex flex-col gap-3 justify-center items-center   min-h-[100vh] mx-2 ">
      <div className="w-full shadow-box	rounded-xl py-2 bg-white  flex flex-col justify-start  flex-wrap items-center min-h-[300px]">
        <div className="w-full py-5 max-w-[70%] flex flex-col flex-wrap items-start  justify-center gap-3 ">
          <h1 className="font-bold text-gray-900 text-left">Followers/Friends</h1>
        </div>
        {
